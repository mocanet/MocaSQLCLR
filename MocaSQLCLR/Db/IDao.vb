...
#Region " Execute "
		...
		''' DBアクセスでエラーが発生した
		''' </exception>
		Function Execute(Of T)(ByVal commandWrapper As IDbCommandSelect, Optional ByVal behavior As CommandBehavior = CommandBehavior.Default) As ISQLStatementResult
