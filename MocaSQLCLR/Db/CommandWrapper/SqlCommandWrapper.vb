...
#Region " Properties "
		...
		''' <remarks>
		''' </remarks>
		Friend ReadOnly Property Command() As IDbCommand Implements IDbCommandSql.Command
			Get
				Return cmd
			End Get
		End Property
		...
		''' <remarks>
		''' </remarks>
		Friend Property PreparedStatement() As Boolean Implements IDbCommandSql.PreparedStatement
			Get
