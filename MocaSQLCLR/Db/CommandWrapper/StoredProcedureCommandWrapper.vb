...
#End Region
		...
		''' </remarks>
		Public Overrides Function Execute(Of T)(Optional ByVal behavior As CommandBehavior = CommandBehavior.Default) As System.Collections.Generic.IList(Of T)
			_addParameterValueCount = 0
			Return MyBase.Execute(Of T)(behavior)
		End Function
